...
class MultiAgentAutogen(BaseAgentSystem):
    def __init__(
        self,
        llm_provider="ollama",
        api_key=None,
...
""",
    ...
    Passages: ["Paris is the capital of France.", "France has many beautiful cities, including Lyon and Nice.", "The Eiffel Tower is located in Paris."]
    ...
    def get_tokenizer(self, model_name="gpt-4"):
        import tiktoken
    ...
    def split_document(self, document, model_name="gpt-4", max_tokens=8192):
    ...
    def predict(self, example: Dict, verbose: bool = False) -> Tuple[str, float]:
        ...
        chunks = self.split_document(
            document, model_name="gpt-4", max_tokens=self.max_tokens
        )
